...
(function($) {
  ...
  var methods = {
    init: function(opts: Options) {
      ...
      opts.disableTeamNameEdit = opts.disableTeamNameEdit || false;
      opts.disableEditButtons = opts.disableEditButtons || false;
